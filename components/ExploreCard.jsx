...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  <motion.div
    ...
    className={`relative ${active === id ? 'lg:flex-[3.5] flex-[10]' : 'lg:flex-[0.5] flex-[2]'} flex items-center justify-center min-w-[170px]  h-[700px] transition-[flex] duration-[0.7s] ease-out-flex cursor-poiter`}
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 flex justify-start w-full flex-col bg-black/50 rounded-b-[24px]">
